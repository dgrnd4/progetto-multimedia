...
def audiotoimage(filename):
    ...
    # read torna data (diviso in 2 canali, 16 bit, 4canali da 8 bit) 
    # e samplerate. semplifichiamo la rappresentazione die pixel in [0,255]
    ...
    # consideriamo la lunghezza e la square del channel1
    length = len(channel1)
    square = length**(0.5)
    ...
    cv2.imwrite("audio.png", allchannel,[cv2.IMWRITE_PNG_COMPRESSION,9])
